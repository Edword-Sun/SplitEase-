...
<#
.SYNOPSIS
  Build frontend Docker image (split_ease-frontend).
...
.EXAMPLE
  .\web\buildImageFrontend.ps1
  .\web\buildImageFrontend.ps1 -Registry myregistry.azurecr.io/myproject -Tag v1.2.3
#>
param(
